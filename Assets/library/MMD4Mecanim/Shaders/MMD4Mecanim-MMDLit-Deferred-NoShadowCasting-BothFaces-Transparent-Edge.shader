Shader "MMD4Mecanim/Deferred/MMDLit-NoShadowCasting-BothFaces-Transparent-Edge"
{
	Properties
	{
	...
	SubShader
	{
		...
		// Memo: Skip PrePassBase for NoShadowCasting & Transparent.

		// Memo: Skip PrePassBase for Edge Transparent.

		// Memo: Added Blend & ColorMask for Deffered Transparent.
		ZWrite On
		...
		Pass {
			...
			#pragma fragmentoption ARB_precision_hint_fastest
			#pragma multi_compile_prepassfinal
			#include "MMD4Mecanim-MMDLit-Deferred-SurfaceEdge-PrePassFinal.cginc"
			ENDCG
		}
	}
